...
const modals = (identifier: string, close: () => void) => {
    const modalComponents: { [key: string]: ModalContent } = {
        register: { component: <RegisterModal close={close} />, title: 'Create a new account' },
        login: { component: <LoginModal close={close} />, title: 'Sign in to your account' }
    };

    return modalComponents[identifier] || null;
};
